...
| --- | --- | --- | --- | --- |
| Medium | Exceeded Low |  | Percentage of memory used | 88    |
| Low | Warning |  | ZAP errors logged - see the zap.log file for details | 1    |
| Low | Warning |  | ZAP warnings logged - see the zap.log file for details | 15    |
...
| Info | Exceeded Low | http://localhost:8002 | Percentage of responses with status code 4xx | 15 % |
