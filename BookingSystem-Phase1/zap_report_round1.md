...
| Low | Exceeded High | http://localhost:8001 | Percentage of responses with status code 5xx | 63 % |
...
| Info | Exceeded Low | http://localhost:8001 | Percentage of responses with status code 4xx | 16 % |
